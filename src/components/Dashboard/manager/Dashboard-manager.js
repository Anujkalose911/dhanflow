...
const Dashboard = () => {
  ...
  const [runTutorial, setRunTutorial] = useState(() => {
    const hasSeenTutorial = localStorage.getItem('hasSeenManagerDashboardTutorial');
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const response = await axios.get('/get-manager-dashboard-data', {
          headers: {
      ...
      <div className="dashboard manager-dashboard">
        <div className="dashboard-header">
          ...
          <div className="action-buttons">
            <button className="btn" onClick={handleViewInvoices}>
              <HiClipboardList className="btn-icon" />
              Review Invoices
            </button>
